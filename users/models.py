...
class FriendshipRequest(models.Model):
    ...
    from_user = models.ForeignKey(
        ...
        related_name="friendship_requests_sent_by",
    )
    to_user = models.ForeignKey(
        AUTH_USER_MODEL,
        on_delete=models.CASCADE,
        related_name="friendship_requests_received_to",
    )
...
class Friend(models.Model):
    ...
    to_user = models.ForeignKey(AUTH_USER_MODEL, models.CASCADE, related_name="friends_all")
    from_user = models.ForeignKey(
        AUTH_USER_MODEL, models.CASCADE, related_name="_unused_friend_relation_yes"
    )
    created = models.DateTimeField(default=timezone.now)
...
class Follow(models.Model):
    ...
    follower = models.ForeignKey(
        AUTH_USER_MODEL, models.CASCADE, related_name="following_wow"
    )
    followee = models.ForeignKey(
        AUTH_USER_MODEL, models.CASCADE, related_name="followers_nah"
    )
    created = models.DateTimeField(default=timezone.now)
...
class Block(models.Model):
    ...
    blocker = models.ForeignKey(
        AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="blocking_why"
    )
    blocked = models.ForeignKey(
        AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="blockees_get"
    )
    created = models.DateTimeField(default=timezone.now)
